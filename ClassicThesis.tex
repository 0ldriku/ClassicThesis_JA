...
\AtBeginDocument{%
    ...
    \renewcommand{\cftchappagefont}{\rmfamily\Large}
    \renewcommand{\cftchappresnum}{\rmfamily\Large}
    ...
    \renewcommand{\cftsubsecfont}{\myHeaderRegularFont\small}
    \renewcommand{\cftsubsecpagefont}{\myHeaderRegularFont\small}
    \renewcommand{\cftsubsecpresnum}{\myHeaderRegularFont\small}
    ...
    % List of Figures (Gothic Regular)
    \renewcommand{\listfigurename}{図目次}
    \@ifpackageloaded{babel}{%
        \addto\captionsamerican{\renewcommand{\listfigurename}{図目次}}%
        \addto\captionsenglish{\renewcommand{\listfigurename}{図目次}}%
    }{}
    \renewcommand{\cftfigfont}{\myHeaderRegularFont\small}
    \renewcommand{\cftfigpagefont}{\myHeaderRegularFont\small}
    \renewcommand{\cftfigpresnum}{図~}
    \renewcommand{\cftfigaftersnum}{}
    \setlength{\cftfignumwidth}{4em}
    
    % List of Tables (Gothic Regular)
    \renewcommand{\listtablename}{表目次}
    \@ifpackageloaded{babel}{%
        \addto\captionsamerican{\renewcommand{\listtablename}{表目次}}%
        \addto\captionsenglish{\renewcommand{\listtablename}{表目次}}%
    }{}
    \renewcommand{\cfttabfont}{\myHeaderRegularFont\small}
    \renewcommand{\cfttabpagefont}{\myHeaderRegularFont\small}
