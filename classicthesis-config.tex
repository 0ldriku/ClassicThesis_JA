...
% 2. Personal data and user ad-hoc commands (insert your own data here)
% ****************************************************************************************************
\newcommand{\myTitle}{ものすごい研究\xspace}
\newcommand{\mySubtitle}{猫と犬の相性に関して\xspace}
\newcommand{\myDegree}{犬博士\xspace}
\newcommand{\myName}{大岡山砂糖\xspace}
\newcommand{\myProf}{ネコ子\xspace}
\newcommand{\myOtherProf}{Your Other Supervisor\xspace}
\newcommand{\mySupervisor}{Your Supervisor\xspace}
\newcommand{\myFaculty}{犬学院\xspace}
\newcommand{\myDepartment}{猫コース\xspace}
\newcommand{\myUni}{東京科学大学\xspace}
\newcommand{\myLocation}{東京\xspace}
...
% \DeclareNameAlias{apaeditor}{apaauthor} % REMOVED: This was forcing Family Given for English too

% Fix editor name format (Given Family for English, Family Given for Japanese)
\DeclareNameFormat{apaeditor}{%
  \iffieldequalstr{langid}{japanese}
    ...
    {% Non-Japanese: Given Family (Initials)
      \ifcase\value{uniquename}%
        \usebibmacro{name:given-family}
          {\namepartfamily}
          {\namepartgiveni}
...
% Disable italics for Japanese titles, and correct APA styling for non-Japanese
% Plain titles for articles, chapters, etc.
\DeclareFieldFormat[article,inbook,incollection,inproceedings]{title}{#1}

% Italic titles for books, reports, etc.
...
% ********************************************************************
%\areaset[current]{370pt}{720pt} % Increased width from default 336pt
\usepackage[a4paper,top=2.8cm,bottom=4cm,inner=25mm,outer=50mm,bindingoffset=5mm]{geometry}
